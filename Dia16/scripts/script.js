        ...
        capsula.forEach(cap =>{
            ...
            <div class="botones">
                <div class="terminadoNegativo">
                    <img src="../Dia16/media/img/pngwing.com (2).png" data-id="${cap["id"]}" alt="" class='completado'>
                </div>
                <div class="eliminadoNegativo">
                    <img src="../Dia16/media/img/pngwing.com (4).png" data-id="${cap["id"]}" alt="" class='eliminado'>
                </div>
            </div>
                `
            ...
            <div class="botones">
                <div class="terminado">
                    <img src="./media/img/pngwing.com (2).png" data-id="${cap["id"]}" alt="" class='completado'>
                </div>
                <div class="eliminar">
                    <img src="./media/img/pngwing.com (4).png" data-id="${cap["id"]}" alt="" class='eliminado'>
                </div>
            </div>`
            }
